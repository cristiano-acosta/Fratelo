	...
	$args = array('orderby' => 'name', 'order' => 'ASC');
		...
		foreach ($posttags as $tag) {
			...
			<div class="span12 tag_title">
								<?php echo '<h3>' . $tag->name . '</h3> '; //echo $category->term_id;				?>
				<div class="row category_slide">
					<?php
					$items_do_cardapio = new WP_Query(array('post_type' => $post_type->name, 'posts_per_page' => -1, 'order' => 'ASC', 'orderby' => 'category', 'tag' => $tag->name));
